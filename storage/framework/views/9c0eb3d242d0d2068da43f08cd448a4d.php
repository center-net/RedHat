                        ...
                        <div class="row">
                                ...
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-1.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                ...
                                                <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark"
                                                        href="<?php echo e(route('frontend.cart')); ?>">Add to cart</a></li>
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Kui Ye Chen’s AirPods</a></h6>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-2.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Air Jordan 12 gym red</a></h6>
                                ...
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-primary">New</div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-3.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Cyan cotton t-shirt</a></h6>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-4.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Timex Unisex Originals</a></h6>
                                ...
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-info">Sale</div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-5.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Red digital smartwatch</a></h6>
                                    <p class="small text-muted">$250</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-6.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Nike air max 95</a></h6>
                                    <p class="small text-muted">$300</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-7.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Joemalone Women prefume</a></h6>
                                    <p class="small text-muted">$25</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-8.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Apple Watch</a></h6>
                                    <p class="small text-muted">$351</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                                ...
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-danger">Sold</div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-9.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Men silver Byron Watch</a></h6>
                                    <p class="small text-muted">$351</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-primary">New</div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-10.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Ploaroid one step camera</a></h6>
                                    <p class="small text-muted">$351</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-11.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Gray Nike running shoes</a></h6>
                                    <p class="small text-muted">$351</p>
                                </div>
                            </div>
                            <!-- PRODUCT-->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white badge-"></div><a class="d-block"
                                            href="<?php echo e(route('frontend.product')); ?>"><img class="img-fluid w-100" src='<?php echo e(asset('assets/frontend/img/product-12.jpg')); ?>'
                                                alt="..."></a>
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                <li class="list-inline-item m-0 p-0"><a
                                    ...
                                    <h6> <a class="reset-anchor" href="<?php echo e(route('frontend.product')); ?>">Black DSLR lense</a></h6>
                                    <p class="small text-muted">$351</p>
                                </div>
                            </div>
                        </div>
              ...
              <div class="modal-body p-0">
                  <div class="row align-items-stretch">
                      <div class="col-lg-6 p-lg-0"><a class="product-view d-block h-100 bg-cover bg-center"
                              style="background: url(<?php echo e(asset('assets/frontend/img/product-5.jpg)')); ?>"
                          ...
                          <div class="p-5 my-md-4">
                              ...
                              <div class="row align-items-stretch mb-4">
                                  ...
                                  <div class="col-sm-5 pl-sm-0"><a
                                          ...
                                          href="<?php echo e(route('frontend.cart')); ?>">Add to cart</a></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\RedHat\resources\views/frontend/shop.blade.php ENDPATH**/ ?>