<div>
    ...
    <table id="example2" class="table table-bordered table-hover">
       ...
       <tr>
          ...
          <td >
             <div class="image">
                <img class="custom_img" src="<?php echo e(asset('/uploads/generalsettings').'/'.$generalsetting->photo); ?>"  alt="صورة الخلفية">       
             </div>
          </td>
       </tr>
       <tr>
          ...
          <td >
             <div class="image">
                <img class="custom_img" src="<?php echo e(asset('/uploads/generalsettings').'/'.$generalsetting->logo); ?>"  alt="لوجو الشركة">       
             </div>
          </td>
       </tr>
       <tr>
...
<?php /**PATH E:\laragon\www\RedHat\resources\views/admin/general-setting/show.blade.php ENDPATH**/ ?>