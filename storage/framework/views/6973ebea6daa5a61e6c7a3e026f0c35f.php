<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #c6a6a7;">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
     <li class="nav-item">
     ...
     <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('admin.Home')); ?>" class="nav-link">الرئيسية</a>
     </li>
     <li class="nav-item d-none d-sm-inline-block">
        <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2446758480-0', $__slots ?? [], get_defined_vars());
...
</nav><?php /**PATH E:\laragon\www\RedHat\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>