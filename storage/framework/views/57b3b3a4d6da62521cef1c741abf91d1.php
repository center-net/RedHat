...
<?php $component = App\View\Components\ModelComponent::resolve(['model' => 'EditModel','title' => 'بيانات  فئات الفواتير','submitName' => 'حفظ'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="col-md-6 mb-0">
        <div class="form-group row">
            ...
            <div class="col-sm-7">
            <input type="text" class="form-control" wire:model="parcode"  placeholder="اسم المنتج">
     ...
     <div class="col-md-4 mb-0">
        <div class="form-group">
           <div class="form-group">
            ...
            <?php else: ?>
                <img class="custom_img" src="<?php echo e(asset('/uploads/admin/product').'/'.$dbimage); ?>" alt="">
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php endif; ?><?php /**PATH E:\laragon\www\RedHat\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>