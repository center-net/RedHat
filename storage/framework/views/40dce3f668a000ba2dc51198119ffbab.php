...
<html>
   ...
   <body class="hold-transition login-page" style="background-image: url(<?php echo e(asset('/uploads/admin/generalsettings/photo.jpg')); ?>) ;background-size: 100%;background-repeate:ni-repeate;">
      <div class="login-box">
